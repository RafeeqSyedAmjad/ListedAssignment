...
function Login({ providers }) {
    return (
        <div className="flex min-h-screen">
            ...
            <div className="flex flex-col items-center justify-center flex-1"> {/* Right Side */}
                <div className="">
                    ...
                    {Object.values(providers).map((provider) => (
                        <div key={provider.name} className='flex items-center justify-center mt-5 xxs:flex-col md:space-x-10 xxs:space-y-3 md:flex-row'>
